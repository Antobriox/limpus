...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900">
      {/* Botón de Iniciar Sesión / Cerrar Sesión - Esquina superior derecha */}
      <div className="fixed top-4 right-4 z-50">
        {user ? (
          <button
            onClick={handleLogout}
            className="bg-gray-200 dark:bg-neutral-800 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-neutral-700 transition font-medium shadow-md"
          >
            Cerrar Sesión
          </button>
        ) : (
